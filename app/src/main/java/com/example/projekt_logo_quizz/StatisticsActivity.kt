...
class StatisticsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val usedHints = sharedPref.getInt("USED_HINTS", 0) // Pobierz licznik użytych podpowiedzi

        findViewById<TextView>(R.id.statsPoints).text = " $totalPoints"
        findViewById<TextView>(R.id.statsGuessed).text = " $guessedLogos"
        findViewById<TextView>(R.id.statsUsedHints).text = " $usedHints" // Wyświetl licznik
